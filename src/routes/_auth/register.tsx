...
function RegisterPage(): JSX.Element {
  ...
  return (
    <motion.div 
      className="rounded-3xl py-6 px-10 shadow-[1px_1px_4px_1px_rgba(96,126,242,0.5)] bg-[#F0F7FF] min-h-[520px]"
    ...
    >
      <div>
        ...
        <div className="space-y-4">
          <div>
            <label htmlFor="email" className="block text-xs text-[#111827] mb-1.5">
              Email
            </label>
            <input
              id="email"
          ...
          <div>
            <label htmlFor="password" className="block text-xs text-[#111827] mb-1.5">
              Password
            </label>
            <input
              id="password"
          ...
          <div>
            <label htmlFor="confirmPassword" className="block text-xs text-[#111827] mb-1.5">
              Confirm Password
            </label>
            <input
              id="confirmPassword"
        ...
        <button
          ...
          className="w-full py-3 mt-6 rounded-lg text-[#F0F7FF] text-xs cursor-pointer shadow-md hover:shadow-lg transition-all bg-[#3A52A6]"
        >
          Sign Up
        </button>
