...
export const Route = createFileRoute("/_landing/mission-vision")({
          ...
          <div className="px-4 sm:px-12 lg:px-26 max-w-7xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 gap-8">
              ...
              <div className="bg-card/75 backdrop-blur-sm border border-secondary/10 rounded-2xl p-8 shadow-xl flex flex-col items-center text-center">
                ...
                <h2 className="text-2xl mb-4 text-secondary">Our Mission</h2>
              ...
              <div className="bg-card/75 backdrop-blur-sm border border-secondary/10 rounded-2xl p-8 shadow-xl flex flex-col items-center text-center">
                ...
                <h2 className="text-2xl mb-4 text-secondary">Our Vision</h2>
                <p className="text-lg text-secondary/80 leading-relaxed">
            ...
            <div className="mt-12 bg-card/75 backdrop-blur-sm border border-secondary/10 rounded-2xl p-8 shadow-xl">
              <div className="flex flex-col items-center text-center mb-8">
                ...
                <h2 className="text-2xl mb-4 text-secondary">Contributing to UN Sustainable Development Goals</h2>
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div className="bg-background/30 rounded-xl p-6 border border-secondary/5">
                  <h3 className="text-xl mb-3 text-secondary">SDG 4 – Quality Education</h3>
                ...
                <div className="bg-background/30 rounded-xl p-6 border border-secondary/5">
                  <h3 className="text-xl mb-3 text-secondary ">SDG 10 – Reduced Inequalities</h3>
                  <p className="text-secondary/80">
                ...
                <div className="bg-background/30 rounded-xl p-6 border border-secondary/5">
                  <h3 className="text-xl mb-3 text-secondary ">SDG 9 – Innovation & Infrastructure</h3>
                  <p className="text-secondary/80">
                ...
                <div className="bg-background/30 rounded-xl p-6 border border-secondary/5">
                  <h3 className="text-xl mb-3 text-secondary ">SDG 17 – Partnerships for the Goals</h3>
                  <p className="text-secondary/80">
