...
const Card = ({ image, name, role, link, isLead = false }: { image: string; name: string; role: string; link: string; isLead?: boolean }) => (
  ...
  `}>
    ...
    <p className="text-sm text-secondary/70 mb-4">{role}</p>
...
export default function TeamSection() {
  return (
    <div id="team" className="bg-background py-36 pb-24 text-secondary relative z-10 w-full overflow-hidden">
      <MotionContainer>
        <div className="px-4 sm:px-12 lg:px-26 max-w-7xl mx-auto">
          ...
          <div className="flex flex-col items-center">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 w-full max-w-6xl justify-items-center">
                  <MotionItem>
                      <Card image="/team/CEO.jpg" name="Justin Luzano" role="CEO & Founder" link="https://www.linkedin.com/in/justinluzano23/" isLead />
                  </MotionItem>
                  
                  <MotionItem>
                      <Card image="/team/COO.jpg" name="Adam Ruadilla" role="COO & Co-Founder" link="https://www.linkedin.com/in/adam-r-35946332a/" />
                  </MotionItem>

                  <MotionItem>
                      <Card image="/team/CTO.jpg" name="Louigie Caminoy" role="CTO & Co-Founder" link="https://www.linkedin.com/in/louie1221" />  
                  </MotionItem>
