  ...
  return (
    ...
    >
      <div className="absolute inset-0 z-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute top-[8%] right-[2%] w-[400px] h-[300px] md:w-[500px] md:h-[380px] lg:w-[550px] lg:h-[425px] opacity-20">
        ...
        <div className="absolute bottom-[15%] left-[3%] w-[200px] h-[150px] md:w-[300px] md:h-[210px] opacity-15 rotate-[-15deg]">
          <svg viewBox="0 0 200 150" className="w-full h-full" preserveAspectRatio="xMidYMid meet">
            <defs>
      ...
      >
        <strong className="text-4xl sm:text-5xl lg:text-6xl xl:text-7xl text-secondary leading-tight text-balance">
